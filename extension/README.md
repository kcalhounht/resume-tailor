...
3. Click **Open in side panel** in the app, or the Resume Tailor toolbar button. The app opens on the right and stays there as you switch tabs.
4. Options → set the Resume Tailor site if it is not `http://localhost:3000`.
